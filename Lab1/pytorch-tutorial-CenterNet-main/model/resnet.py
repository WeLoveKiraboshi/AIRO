...
import sys
sys.path.append('/home/yukisaito/ECN.AIRO/Lab1/pytorch-tutorial-CenterNet-main')#os.getcwd())
sys.path.append('/home/yukisaito/DCNv2_latest-master/')
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, inC, outC, halve_size=False):
        ...
        if self.halve_size == False:
            self.conv1 = nn.Conv2d(inC, outC, kernel_size=3, stride=1, padding=1, bias=False)  # TODO: declare value of kernel_size, stride, and padding
            self.bn1 = nn.BatchNorm2d(outC)
            self.conv2 = nn.Conv2d(outC, outC, kernel_size=3, stride=1, padding=1, bias=False)  # TODO: declare value of kernel_size, stride, and padding
        ...
        self.bn_skip = None
        if self.halve_size:
            self.conv_skip = nn.Conv2d(inC, outC, kernel_size=1, stride=2, bias=False)  # TODO: declare value of kernel_size, stride, and padding
...
class UpSampleLayer(nn.Module):
    ...
    def __init__(self, inC, outC):
        ...
        self.defconv = DCN(inC, outC, kernel_size=3, stride=1, padding=1) # TODO: declare value of kernel_size, stride, and padding
        self.bn1 = nn.BatchNorm2d(outC)
...
class ResNet18(nn.Module):
    def __init__(self):
        ...
        self.maxpool1 = nn.MaxPool2d(kernel_size=3,
                                     stride=2, padding=1)  # TODO: declare value of kernel_size, stride, and padding
        # NOTE: after passing through maxpool1, image size is reduced by 4

        # down-sampling path made of ResNet18
        self.conv2_1 = BasicLayer(64, 64, False)  # TODO: declare inC, outC, halve_size
        self.conv2_2 = BasicLayer(64, 64, False)  # TODO: declare inC, outC, halve_size

        self.conv3_1 = BasicLayer(64, 128, True)  # TODO: declare inC, outC, halve_size
        self.conv3_2 = BasicLayer(128, 128, False)  # TODO: declare inC, outC, halve_size

        self.conv4_1 = BasicLayer(128, 256, True)  # TODO: declare inC, outC, halve_size
        self.conv4_2 = BasicLayer(256, 256, False)  # TODO: declare inC, outC, halve_size

        self.conv5_1 = BasicLayer(256, 512, True)  # TODO: declare inC, outC, halve_size
        self.conv5_2 = BasicLayer(512, 512, False)  # TODO: declare inC, outC, halve_size

        # up-sampling path
        # NOTE: compared to Figure.6 UpSampleLayer below are indexed from bottom to top
        # (meaning self.up3 is the last one)
        self.up1 = UpSampleLayer(512, 256)  # TODO: declare inC, outC
        self.up2 = UpSampleLayer(256, 128)  # TODO: declare inC, outC
        self.up3 = UpSampleLayer(128, 64)  # TODO: declare inC, outC
