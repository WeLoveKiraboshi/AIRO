...
class DetectionVisualization:
	...
	def draw_box(self, box, axe):
		...
		# draw box
		corners_order = range(0,4) #range(-1, 4)
		print('corners_order = {}'.format(corners_order))
		axe.plot(corners[corners_order, 0], corners[corners_order, 1], linewidth=2, color=self.colors[obj_type])
		# axe.plot(corners[0, 0], corners[1, 1], linewidth=2, color=self.colors[obj_type])
		# axe.plot(corners[1, 0], corners[2, 1], linewidth=2, color=self.colors[obj_type])
		# axe.plot(corners[2, 0], corners[3, 1], linewidth=2, color=self.colors[obj_type])
		# axe.plot(corners[3, 0], corners[0, 1], linewidth=2, color=self.colors[obj_type])
